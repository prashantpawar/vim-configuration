...
let s:bwc.xtralightgravel= ['c5c1bd', 245]
let s:bwc.gravel         = ['cac0b6', 243]
let s:bwc.mediumgravel   = ['9a9794', 241]
...
let s:bwc.dirtyblonde = ['22f0bd', 222]

" Delicious, chewy red from Made of Code for the poppiest highlights.
let s:bwc.taffy = ['ffa0df', 196]
